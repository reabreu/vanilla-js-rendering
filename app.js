...
var _this = this;
var targetElem = document.querySelector(".repo-list");
var getRepos = function () { return __awaiter(_this, void 0, void 0, function () {
    var reposRes;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, fetch("https://api.github.com/users/reabreu/repos")];
            case 1:
                reposRes = _a.sent();
                return [4 /*yield*/, reposRes.json()];
            case 2: return [2 /*return*/, _a.sent()];
        }
    });
}); };
var repos = getRepos().then(renderRepos);
// innerHTML
...
function renderRepos(repos) {
    ...
    var table = document
        ...
        .querySelector(".tbody");
    var tableTrTemplate = document.getElementById("table-tr-template");
    repos.forEach(function (repo) {
        var trRow = document.importNode(tableTrTemplate.content, true);
